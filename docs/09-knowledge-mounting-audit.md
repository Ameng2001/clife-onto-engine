...
**✅ 公开标准值已固化（专家轮·本轮，去 TODO、精确 citation）**：

| 项 | 值 | 依据 |
|---|---|---|
| 黄曲霉毒素 B1 限量 `MOLD_LIMIT` | 0.05 mg/kg（肉牛/肉羊；奶牛 0.01 更严） | GB 13078 饲料卫生标准 |
| RFV 分级断点 | 特级≥151·一级125–150·二级103–124·三级87–102·等外<87 | AFGC RFV / NY/T 1574 |
| 快检必备检测项 | CP / NDF / ADF / RFV | NY/T 1574 |

**🔴 仍待蒙草专家（专有值，我无法权威提供；规则逻辑已就位、只等换数）**：

| 项 | 现状 | 待专家给 |
|---|---|---|
| **播量区间** seeding_rate | 碱茅[1.0,2.5] 等 demo | 真实品种播种技术规程值 |
| **立地适配** adapts_to（真边） | 碱茅→盐碱/沙地 等 demo | 蒙草案例库/研究核准 + 案例 ID |
| **各盟市乡土名录** | 巴彦淖尔5/乌兰察布4 | 各盟市完整名录 |
